...
//   form.watch('picture')
//   const { trigger, isMutating } = useSWRMutation("/collections", postFetcher, { revalidate: true })
...
//           </Button>
//           <Button 
//           type="submit" color='green' onClick={form.handleSubmit(onSubmit)}>Submit</Button>
//         </DialogFooter>
//       </Dialog>
//     </>
//   )
