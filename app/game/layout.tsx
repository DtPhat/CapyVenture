      ...
      <div className="text-lg w-full">
        <Menu offset={10}>
          <div className='flex justify-center items-center gap-4'>
            ...
            <MenuHandler>
              <Button variant='outlined' className="p-2 border-black/50 border-2 rounded-lg flex items-center gap-1 text-primary border-primary">
                <span className="normal-case text-lg">Academic Writing</span>
                <ChevronDownIcon className="w-6 h-6" />
              </Button>
            </MenuHandler>
          </div>
          <MenuList className="p-1 text-black bg-purewhite flex flex-col gap-1 min-w-52">
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-8">
          <Link href='/game/flashcard' className="space-y-2">
            <Card className="overflow-hidden hover:bg-secondary/20 p-4 flex justify-center flex-col items-center gap-8 group">
              <RectangleStackIcon className='w-40 h-40 text-accent' />
              <CardHeader
                shadow={false}
                color="transparent"
